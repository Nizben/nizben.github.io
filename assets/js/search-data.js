...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/CV_Janvier26.pdf";
          },
      ...
      handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-thrilled-to-start-my-phd-co-supervised-by-professors-xi-wang-and-adnane-boukhayma-at-école-polytechnique",
          title: 'Thrilled to start my PhD co-supervised by professors Xi Wang and Adnane Boukhayma...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%69%7A%61%72%62%65%6E%62%6F%75%63%68%74%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Nizben", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
